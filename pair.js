...
const config = {
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/ebj284.jpg',
        MENU: 'https://files.catbox.moe/ebj284.jpg',
        OWNER: 'https://files.catbox.moe/ebj284.jpg',
        SONG: 'https://files.catbox.moe/ebj284.jpg',
        VIDEO: 'https://files.catbox.moe/ebj284.jpg'
    }
};
...
case 'menu': {
    ...
    const title = `𝚂𝙸𝙻𝙰 𝙼𝙳`;
    const footer = `𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚂𝙸𝙻𝙰 𝙼𝙳 `;
...
await socket.sendMessage(userJid, {
    ...
    caption: formatMessage(
        ...
        '𝚂𝙸𝙻𝙰 𝙼𝙳'
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝚂𝙸𝙻𝙰 𝙼𝙳'}`);
                }
            }
        });
    } catch (error) {
